...
public String transformYouMeStatement(String statement) {
    ...
    public String getResponse(String statement) {
        ...
        String statementblank = statement.trim();

        
        
        if (findKeyword(statement, "mother", 0) >= 0 || findKeyword(statement, "father", 0) >= 0 || findKeyword(statement, "sister", 0) >= 0){
        ...
        } else if (findKeyword(statement, "leon", 0) >= 0) {
            response = "He sounds like a fun person.";
        } else if (findKeyword(statement, "googoo", 0) >= 0) {
            response = "are you a baby?";
        } else if (statementblank.length() == 0 ) {
       ...
       if (statement.indexOf("dog") >= 0
        || statement.indexOf("cat") >= 0) {
            response = "Tell me more about your pets.";
        } else if (statement.indexOf("leon") >= 0) {
            response = "He sounds like a fun person.";
        } else if (statementblank.length() == 0 ) {
            response = "Say something now.";
        } else if (statement.indexOf("googoo") >= 0) {
            response = "are you a baby?";
        } else if (statement.indexOf("woof") >= 0) {
            response = "are you a dog?";
